...
angular.module('hipFlowApp')
  .filter('emoji', function () {
    ...
    var emojiKeywordsRegex = new RegExp(':(' + emojKeywords.join('|') + '):', 'g');

    var emojiUnicodes = ['😄', '😊', '😃', '☺', '😉', '😍', '😘', '😚', '😳', '😌', '😁', '😜', '😝', '😒', '😏', '😓', '😔', '😞', '😖', '😥', '😰', '😨', '😣', '😢', '😭', '😂', '😲', '😱', '😠', '😡', '😪', '😷', '👿', '👽', '😇', '💛', '💙', '💜', '💗', '💚', '❤', '💔', '💓', '💘', '✨', '🌟', '💢', '❕', '❔', '💤', '💨', '💦', '🎶', '🎵', '🔥', '💩', '👍', '👎', '👌', '👊', '✊', '✌', '👋', '✋', '👐', '👆', '👇', '👉', '👈', '🙌', '🙏', '☝', '👏', '💪', '🚶', '🏃', '👫', '💃', '👯', '🙆', '🙅', '💁', '🙇', '💏', '💑', '💆', '💇', '💅', '👦', '👧', '👩', '👨', '👶', '👵', '👴', '👱', '👲', '👳', '👷', '👮', '👼', '👸', '💂', '💀', '👣', '💋', '👄', '👂', '👀', '👃', '☀', '☔', '☁', '⛄', '🌙', '⚡', '🌀', '🌊', '🐱', '🐶', '🐭', '🐹', '🐰', '🐺', '🐸', '🐯', '🐨', '🐻', '🐷', '🐮', '🐗', '🐵', '🐒', '🐴', '🐎', '🐫', '🐑', '🐘', '🐍', '🐦', '🐤', '🐔', '🐧', '🐛', '🐙', '🐠', '🐟', '🐳', '🐬', '💐', '🌸', '🌷', '🍀', '🌹', '🌻', '🌺', '🍁', '🍃', '🍂', '🌴', '🌵', '🌾', '🐚', '🎍', '💝', '🎎', '🎒', '🎓', '🎏', '🎆', '🎇', '🎐', '🎑', '🎃', '👻', '🎅', '🎄', '🎁', '🔔', '🎉', '🎈', '💿', '📀', '📷', '🎥', '💻', '📺', '📱', '📠', '☎', '💽', '📼', '🔊', '📢', '📣', '📻', '📡', '➿', '🔍', '🔓', '🔒', '🔑', '✂', '🔨', '💡', '📲', '📩', '📫', '📮', '🛀', '🚽', '💺', '💰', '🔱', '🚬', '💣', '🔫', '💊', '💉', '🏈', '🏀', '⚽', '⚾', '🎾', '⛳', '🎱', '🏊', '🏄', '🎿', '♠', '♥', '♣', '♦', '🏆', '👾', '🎯', '🀄', '🎬', '📝', '📖', '🎨', '🎤', '🎧', '🎺', '🎷', '🎸', '〽', '👟', '👡', '👠', '👢', '👕', '👔', '👗', '👘', '👙', '🎀', '🎩', '👑', '👒', '🌂', '💼', '👜', '💄', '💍', '💎', '☕', '🍵', '🍺', '🍻', '🍸', '🍶', '🍴', '🍔', '🍟', '🍝', '🍛', '🍱', '🍣', '🍙', '🍘', '🍚', '🍜', '🍲', '🍞', '🍳', '🍢', '🍡', '🍦', '🍧', '🎂', '🍰', '🍎', '🍊', '🍉', '🍓', '🍆', '🍅', '🏠', '🏫', '🏢', '🏣', '🏥', '🏦', '🏪', '🏩', '🏨', '💒', '⛪', '🏬', '🌇', '🌆', '🏯', '🏰', '⛺', '🏭', '🗼', '🗻', '🌄', '🌅', '🌃', '🗽', '🌈', '🎡', '⛲', '🎢', '🚢', '🚤', '⛵', '✈', '🚀', '🚲', '🚙', '🚗', '🚕', '🚌', '🚓', '🚒', '🚑', '🚚', '🚃', '🚉', '🚄', '🚅', '🎫', '⛽', '🚥', '⚠', '🚧', '🔰', '🏧', '🎰', '🚏', '💈', '♨', '🏁', '🎌', '🇯🇵', '🇰🇷', '🇨🇳', '🇺🇸', '🇫🇷', '🇪🇸', '🇮🇹', '🇷🇺', '🇬🇧', '🇩🇪', '1⃣', '2⃣', '3⃣', '4⃣', '5⃣', '6⃣', '7⃣', '8⃣', '9⃣', '0⃣', '#⃣', '⬆', '⬇', '⬅', '➡', '↗', '↖', '↘', '↙', '◀', '▶', '⏪', '⏩', '🆗', '🆕', '🔝', '🆙', '🆒', '🎦', '🈁', '📶', '🈵', '🈳', '🉐', '🈹', '🈯', '🈺', '🈶', '🈚', '🈷', '🈸', '🈂', '🚻', '🚹', '🚺', '🚼', '🚭', '🅿', '♿', '🚇', '🚾', '㊙', '㊗', '🔞', '🆔', '✳', '✴', '💟', '🆚', '📳', '📴', '💹', '💱', '♈', '♉', '♊', '♋', '♌', '♍', '♎', '♏', '♐', '♑', '♒', '♓', '⛎', '🔯', '🅰', '🅱', '🆎', '🅾', '🔲', '🔴', '🔳', '🕛', '🕐', '🕑', '🕒', '🕓', '🕔', '🕕', '🕖', '🕗', '🕘', '🕙', '🕚', '⭕', '❌', '©', '®', '™'];
    var emojiUnicodesRegex = new RegExp('(' + emojiUnicodes.join('|') + ')', 'g');

    var emojiUnicodeKeywordMap = {
      '😄': 'smile',
      '👏': 'clap',
      '😁': 'grin',
      '👋': 'wave',
    ...
    var makeImg = function (emoji) {
      return '<img class="emoji emoji-' + emoji + '" src="/images/emojis/' + emoji + '.png">';
    };
    ...
    return function (input) {
      ...
      input = input.replace(emojiUnicodesRegex, function (match, character) {
        var keyword = emojiUnicodeKeywordMap[character];
